...
/************************************************************
 ...
 Version - 1.0.0
 Date - 30/04/2019
 Description - Activity for welcome screens on initial install
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(prefManager.isFirstTimeLaunch()) {
            locationFirst = getSharedPreferences("locationFirst", Context.MODE_PRIVATE);
            SharedPreferences.Editor editor = locationFirst.edit();
        ...
        if(android.os.Build.VERSION.SDK_INT > 22){
            if(isGETACCOUNTSAllowed()){
                ...
                AlertDialog.Builder account = new AlertDialog.Builder(this);
                account.setTitle("Permission");
                account.setMessage("The app needs permission to access your account to generate a username" +
                        "click deny on the next screen to set your own username");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == REQUEST_GET_ACCOUNT){
            ...
            if(grantResults.length >0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                AlertDialog.Builder account = new AlertDialog.Builder(this);
                final EditText enterUsername = new EditText(this);
                enterUsername.setHint("enter username");
                account.setTitle("UserName");
                account.setView(enterUsername);

                account.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        userName = enterUsername.getText().toString();
                        accountName = getSharedPreferences("account", Context.MODE_PRIVATE);
                        SharedPreferences.Editor editor = accountName.edit();
                ...
                account.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        requestGET_ACCOUNTSPermission();
                    }
